! function(t, e) {
    ! function t(e, n, o, a) {
        ...
        var c, s, u, h, d, f = (u = Math.floor(1e3 / 60), h = {}, d = 0, "function" == typeof requestAnimationFrame && "function" == typeof cancelAnimationFrame ? (c = function(t) {
                var e = Math.random();
                return h[e] = requestAnimationFrame(function n(o) {
                ...
                return function() {
                    ...
                    if (!o && i) {
                        ...
                        try {
                            ...
                            return void 0 !== typeof console && "function" == typeof console.warn && console.warn("�~_~N~J Count not load worker", t), null
                        }! function(t) {
                            function e(e, n) {
                                t.postMessage({
                                    options: e || {},
                            ...
                            t.init = function(e) {
                                ...
                                return n = l(function(i) {
                                    ...
                                    t.addEventListener("message", l), e(o, c), a[c] = l.bind(null, {
                                        data: {
                                            callback: c
                                        }
                                    })
        ...
        function M(t, e, n, i, r) {
            var c, s, u = e.slice(),
                ...
                d = l(function(e) {
					    ...
					    e.y += Math.sin(e.angle2D) * e.velocity + e.gravity, e.wobble += .1, 
					    e.velocity *= e.decay, e.tiltAngle += .1, 
					    e.tiltSin = Math.sin(e.tiltAngle), 
					    e.tiltCos = Math.cos(e.tiltAngle), e.random = Math.random() + 5, 
					    ...
					    return t.fillStyle="rgba("+e.color.r+", "+e.color.g+", "+e.color.b+", "+(1-n)+")",
						   ...
						   "circle"===e.shape?
						     t.ellipse?
						       t.ellipse(e.x,e.y,Math.abs(i-o)*e.ovalScalar,Math.abs(r-a)*e.ovalScalar,Math.PI/10 * e.wobble, 0, 2 * Math.PI)
						     : function(t, e, n, o, a, i, r, l, c) {t.save(), t.translate(e, n), t.rotate(i), t.scale(o, a), t.arc(0, 0, 1, r, l, c), t.restore()}(t, e.x, e.y, Math.abs(i - o) * e.ovalScalar, Math.abs(r - a) * e.ovalScalar, Math.PI / 10 * e.wobble, 0, 2 * Math.PI)
						   : "text:"===e.shape.substring(0, 5)?
						     t.fillText(e.shape.substring(5),o,a)
						   : (t.moveTo(Math.floor(e.x), Math.floor(e.y)), t.lineTo(Math.floor(e.wobbleX), Math.floor(a)), t.lineTo(Math.floor(i), Math.floor(r)), t.lineTo(Math.floor(o), Math.floor(e.wobbleY))),
						   t.closePath(), 
						   t.fill(), 
						   e.tick < e.totalTicks
                                    }(h, t)
    ...
    function w(t, n) {
        ...
        function f(e, n, a) {
            for (var i, r, l, c, s, h, d, f = b(e, "particleCount", Math.floor), g = b(e, "angle", Number), m = b(e, "spread", Number), y = b(e, "startVelocity", Number), p = b(e, "decay", Number), w = b(e, "gravity", Number), x = b(e, "colors"), C = b(e, "ticks", Number), k = b(e, "shapes"), I = function(t) {
                    var e = b(t, "origin", Object);
                    return e.x = b(e, "x", Number), e.y = b(e, "y", Number), e
                }(e), T = f, E = [], S = t.width * I.x, F = t.height * I.y; T--;) E.push((i = {
                x: S,
                y: F,
                angle: g,
                spread: m,
                ...
                decay: p,
                gravity: w
            }, r = void 0, l = void 0, c = void 0, s = void 0, c = i.angle * (Math.PI / 180), s = i.spread * (Math.PI / 180), {
                x: i.x,
                y: i.y,
                wobble: 10 * Math.random(),
                velocity: .5 * i.startVelocity + Math.random() * i.startVelocity,
                angle2D: -c + (.5 * s - Math.random() * s),
                tiltAngle: Math.random() * Math.PI,
                color: (r = i.color, l = String(r).replace(/[^0-9a-f]/gi, ""), l.length < 6 && (l = l[0] + l[0] + l[1] + l[1] + l[2] + l[2]), {
                    r: v(l.substring(0, 2)),
                    g: v(l.substring(2, 4)),
                    b: v(l.substring(4, 6))
                }),
        ...
        function m(n) {
            ...
            function y() {
                o = null, r && e.removeEventListener("resize", v), a && t && (document.body.removeChild(t), t = null, h = !1)
            }
