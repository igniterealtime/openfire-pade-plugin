...
public class CallEvent {
    ...
    public static final int SIP_REGISTRATION      = 18;

    private static final int LAST_EVENT = 18;
    ...
    public CallEvent(int event, String extension, String sipUri)
    {
		this.event = event;
	...
	if (event == SIP_REGISTRATION)
	{
		s = "SIP Registration on " + extension + " from " + sipUri;
	}
