...
public class RuntimeConfiguration
{
    ...
    {
        return JiveGlobals.getIntProperty(PluginImpl.SINGLE_PORT_NUMBER_PROPERTY_NAME, SINGLE_PORT_DEFAULT_VALUE );
    }
    ...
    public static boolean isTcpEnabled()
    {
        ...
        return !JiveGlobals.getBooleanProperty(DISABLE_TCP_HARVESTER, DISABLE_TCP_HARVESTER_DEFAULT_VALUE );
    }
    ...
    {
        return JiveGlobals.getBooleanProperty(TCP_HARVESTER_SSLTCP, SSLTCP_TCP_HARVESTER_DEFAULT_VALUE );
    }
