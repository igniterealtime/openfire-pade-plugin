...
/**
 * A SaslServerFactory implementation that is used to instantiate OfChat-specific SaslServer instances.
 *
 * @author Guus der Kinderen, guus.der.kinderen@gmail.com
 */
public class OfChatSaslServerFactory implements SaslServerFactory
{
    public SaslServer createSaslServer( String mechanism, String protocol, String serverName, Map<String, ?> props, CallbackHandler cbh ) throws SaslException
    {
        ...
        if ( mechanismNames.contains( mechanism ) && mechanism.equalsIgnoreCase( OfChatSaslServer.MECHANISM_NAME ) )
        {
            return new OfChatSaslServer();
        }
    ...
    protected final Set<String> getMechanismNamesSet( Map<String, ?> props )
    {
        ...
        supportedMechanisms.add( OfChatSaslServer.MECHANISM_NAME );
        ...
        if ( props != null )
        {
            for ( Map.Entry<String, ?> prop : props.entrySet() )
            {
                ...
                {
                    supportedMechanisms.remove( OfChatSaslServer.MECHANISM_NAME );
                }
