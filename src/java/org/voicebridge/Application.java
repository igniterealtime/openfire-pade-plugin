...
*/
    ...
    private void parseCallParameters(String parameter, String value, CallParticipant cp, String uid)
    {
		...
		{
			if (value.equalsIgnoreCase("SIP") == false && value.equalsIgnoreCase("NS") == false && value.equalsIgnoreCase("WebRtc") == false && value.equalsIgnoreCase("Rtmfp") == false && value.equalsIgnoreCase("Speaker") == false && value.equalsIgnoreCase("Multicast") == false)
			{
